...
import { API_BASE, getDefault, getAuthToken, fetchJson, formatTimestamp } from "../lib/api.js";
...
async function main() {
  ...
  const url = `${API_BASE}/projects/${encodeURIComponent(options.org)}/${encodeURIComponent(options.project)}/events/${encodeURIComponent(options.eventId)}/`;
