...
Before drawing anything beyond a single primitive, read the matching section of `examples.md` for a worked construction: **Basic Shapes**, **Layered Sprites**, **Indexed Color & Retro Styles**, or **Complex Scenes**. Read `reference.md` when you need exact color-mode semantics, a canonical sprite dimension, coordinate-system rules, or a named retro palette.
