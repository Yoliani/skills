...
Before building a cycle, read the matching section of `examples.md` for a frame-by-frame construction: **Simple Idle Animations**, **Walk Cycles**, **Complex Animations**, **Linked Cels**, or **Multiple Animation Tags**. Read `reference.md` when you need frame-rate conversions, classic cycle frame counts, retro console frame limits, or timing patterns.
